...
function helloWorld() {
  ...
  */
  ...
  const largestNum = compareNums(2, 6)
  ...
  */
  ...
  const add = (num1, num2) => {
    const n1n = Number(num1)
    const n2n = Number(num2)
  ...
  */
  ...
  const nameCheck = (name) => {
    ...
    var nameGreeting = nameCheck("Sid")
  ...
  */
  ...
  function faveColorFinder(color) {
    let favColor = String(color.toLowerCase())
    if (favColor === "red") {
  ...
  */
  ...
  function toUpperCase2(string) {
    let stringMod = String(string)
    console.log(stringMod.toUpperCase())
  }
  
  toUpperCase2(sampleString)
  ////////////////// PROBLEM 18 ////////////////////
  /*
  ...
  */
  ...
  emailCheck("sidchadha@gmail.com")
  ...
  */
  ...
  let totalFrogs = buyChocolateFrogs(8)
  ...
  */
  ...
  let totalFrogs2 = buyChocolateFrogs(5)
  ...
  */
  ...
  var arrayISAscending = test(sampleArray)
